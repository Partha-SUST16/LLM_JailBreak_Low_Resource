...
def process_csv(input_file, output_file, batch_size=8, max_new_tokens=1500):
    ...
    if not os.path.exists(output_file):
        with open(output_file, mode="w", encoding="utf-8", newline="") as outfile:
            fieldnames = ["id", "original_prompt", "response"]
    ...
    for i in range(0, len(all_rows), batch_size):
        ...
        with open(output_file, mode="a", encoding="utf-8", newline="") as outfile:
            writer = csv.DictWriter(outfile, fieldnames=["id", "original_prompt", "response"])
...
input_file = '/home/pppaul/projects/def-rtholmes-ab/pppaul/Security Course/Commons/en_common_prompts.csv'
output_file = '/home/pppaul/projects/def-rtholmes-ab/pppaul/Security Course/Commons/Response/deepseek/deepseek_en_common_prompts.csv'
